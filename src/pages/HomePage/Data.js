...
export const homeObjFour = {
  description1:
    "DeemPay enables you to accept QR code easily, with just your smartphone or cashier computer. No POS device needed.",
  description2:
    "You can easily generate payment request, and share it to your customers via WhatsApp or other social media.",
  description3:
    "With DeemPay App, you can add a subaccount to receive payment on your behalf and still have the money settled to your account.",
  description4:
    "DeemPay helps you reconcile all payment collected from different cashier points and present it to you on the dashboard.",
