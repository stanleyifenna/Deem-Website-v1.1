    ...
    <Routes>
      <InfoSec>
        <Container>
          ...
          <SubHead>Effective Date October 2021</SubHead>
        </Container>
      </InfoSec>
      <InfoSec2>
        <Container>
          <SubTitle>
            ...
            protecting your personal information and your right to TermsofService. If
            ...
            us at hello@deempay.com.
          </SubTitle>
          <SubTitle2>In this privacy notice, if we refer to:</SubTitle2>
          <TopLine>
          ...
          <SubTitle2>
            ...
            numbers; email addresses; passwords; gender; birthday; id number;
            business type; business name; business category; business section;
            state; city; bank; bank account number; BVN; and other similar
            information.
          </SubTitle2>
          <SubTitle2>
          ...
          <Header>Information collected through our App</Header>
          <SubTitle2>
          ...
          <TopLine>
            ...
            location-based services and for security check. If you wish to
          ...
          <TopLine>
            ...
            device's camera, contacts, SMS messages, storage, gallery, and other
          ...
          <SubTitle2>We use the information we collect or receive:</SubTitle2>

          <TopLine>■ To facilitate account creation and logon process.</TopLine>

          <TopLine>■ To generate QR code for you.</TopLine>

          <TopLine>■ To settle money to your bank account</TopLine>
          ...
          <Header>WILL YOUR INFORMATION BE SHARED WITH ANYONE?</Header>
          ...
          <Header>WHO WILL YOUR INFORMATION BE SHARED WITH?</Header>
          <SubTitle2>
            We only share and disclose your information with the following
            categories of third parties.
          </SubTitle2>

          <TopLine>■ Cloud Computing Services</TopLine>
          <TopLine>■ Communication & Collaboration Tools</TopLine>

          <TopLine>■ Data Analytics Services</TopLine>
          <TopLine>■ Finance & Accounting Tools</TopLine>
          <TopLine>■ Government Entities</TopLine>

          <TopLine>■ Payment Processors</TopLine>
          ...
          <Header>HOW DO WE KEEP YOUR INFORMATION SAFE?</Header>
          ...
          <SubTitle2>
            ...
            cybercriminals, or other unauthorized hird parties will not be able
          ...
          <Header>DO WE COLLECT INFORMATION FROM MINORS?</Header>
          ...
          <SubTitle2>
            ...
            age 18, please contact us at hello@deempay.com.
          </SubTitle2>
          <Header>WHAT ARE YOUR PRIVACY RIGHTS?</Header>

          <SubTitle2>
            You may review, change, or terminate your account at any time. If
            you have questions or comments about your privacy rights, you may
            email us at hello@deempay.com.
          </SubTitle2>
          ...
          <Header>DO WE MAKE UPDATES TO THIS NOTICE?</Header>
          ...
          <Header>HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</Header>

          <SubTitle2>
            If you have questions or comments about this notice, you may email
            us at hello@deempay.com or by post to:
          </SubTitle2>
          <SubTitle2>DeemPay Technology Limited</SubTitle2>
          <SubTitle2>294 Herbert Macaulay Way, Yaba , Lagos</SubTitle2>
          <SubTitle2>Lagos, Lagos 101212</SubTitle2>
          <SubTitle2>Nigeria</SubTitle2>
        </Container>
      </InfoSec2>
    </Routes>
  );
